...
export default function ContactPageSection() {
  return (
    <main className="bg-gradient-to-b from-white via-sky-50/30 to-white">
      <section className="max-w-7xl mx-auto px-6 py-20">
        {/* Head Office + Factory */}
        <div className="grid md:grid-cols-2 gap-10 mb-20">
          {/* Head Office */}
          <div className="bg-white rounded-2xl p-8 border border-primary/20 shadow-sm hover:shadow-xl transition">
            ...
            <p className="text-sm mt-4 flex items-center gap-2 text-gray-700">
              <FaPhoneAlt className="text-primary" />
              +88 02-41050459, 02-41050457
            </p>

            <p className="text-sm flex items-center gap-2 mt-2 text-gray-700">
              <FaEnvelope className="text-primary" />
              hrbplho@gmail.com
            </p>
          </div>
