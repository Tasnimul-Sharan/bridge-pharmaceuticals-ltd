...
//       <h2 className="bg-gradient-to-r from-secondary to-secondary_two text-white text-xl font-semibold px-6 py-4">
//         {product.name}
//       </h2>
...
export default function ProductInfo({ product }) {
  ...
  return (
    <div className="bg-white border rounded-md sticky top-24 overflow-hidden flex flex-col min-h-[500px]">
      <h2 className="bg-gradient-to-r from-secondary to-secondary_two text-white text-xl font-semibold px-6 py-4">
        {product.name}
      </h2>

      <div className="p-6 text-sm flex flex-col flex-1 gap-6">
        {/* Generic */}
        <div>
          <p className="text-gray-500 uppercase text-xs tracking-wide">
            Generic Name
        ...
        <div className="mt-auto">
          <button
            onClick={() => generatePrescriptionPdf(product)}
            className="w-full flex items-center justify-center gap-2 bg-secondary hover:bg-secondary_two transition-all transform duration-500 text-white py-3 rounded-md font-medium"
          >
            <FaFilePdf />
            View Prescribing Details
          </button>
          ...
          <div className="pt-4 border-t mt-4">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 rounded-full bg-sky-500 text-white"
              >
                <FaTwitter size={14} />
              </a>
